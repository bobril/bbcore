...
{
    public AstAccessor(string? source, Position startPos, Position endPos, ref StructList<AstNode> argNames, bool isGenerator, bool async, ref StructRefList<AstNode> body) : base(source, startPos, endPos, null, ref argNames, isGenerator, async, ref body)
    {
    }
