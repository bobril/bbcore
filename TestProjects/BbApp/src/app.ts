...
let page = b.createVirtualComponent({
  ...
  render(ctx: IPageCtx, me: b.IBobrilNode, _oldMe?: b.IBobrilCacheNode): void {
    ...
    me.children = [
      ...
      },
      {
        ...
        children: [
          g.serializationKeysLoaded()
            ? g.formatSerializedMessage(
                g.serializeMessage(g.dt("Delayed translation message"))
              )
            : "Loading ..."
        ]
      },
      ...
      b.styledDiv(
        " ",
        { backgroundColor: "blue", display: "inline-block" },
      ...
      },
      {
        tag: "p",
        children:
          "Moment long date format L: " +
          (<any>m.localeData()).longDateFormat("L")
      },
      {
        tag: "p",
        children:
