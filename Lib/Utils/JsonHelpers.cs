...
public static class JsonHelpers
{
    ...
    public static JsonObject ParseObject(string json)
    {
        try
        {
            return JsonNode.Parse(json, null, new() { AllowTrailingCommas = true, CommentHandling = JsonCommentHandling.Skip })!.AsObject();
        }
        catch (JsonException)
        {
            return JsonNode.Parse(ToStrictJson(json), null, new() { AllowTrailingCommas = true, CommentHandling = JsonCommentHandling.Skip })!.AsObject();
        }
    }
