...
//             var ctx = new BuildCtx(_dc, _verbose, proj.Owner.Owner.FullPath, _buildCache,
...
//                     {
//                         var bundle = (IBundler)new NjsastBundleBundler(_tools, _mainBuildResult, proj,
//                                 buildResult);
...
//     }
//
//     void PrintMessages(IList<Diagnostic> messages, bool onlySemantic = false) // todo
//     {
...
//             {
//                 var ctx = new BuildCtx(_dc, _verbose, proj.Owner.Owner.FullPath,
//                     _buildCache, "yes");
...
//         var proj = TSProject.Create(dirCache, _dc, null);
...
//         var req = JsonSerializer.Deserialize<TReq>(reqBody,
...
//     }
//
//     public static bool FindInFilesContent(string pathWithoutFirstSlash,
...
//         var iterationId = 0;
//         var ctx = new BuildCtx(_dc, _verbose, _currentProject.Owner.Owner.FullPath,
//             _buildCache, "yes");
